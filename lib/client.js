window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function buildHourLevels(days, th) {
			const nonZero = [];
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: lang === "en" ? "Level thresholds" : "分档阈值" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: { color: "var(--dsw-alias-label-tertiary)" },
												children: thOpen ? "▾" : "▸"
											})]
										}),
										thOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											style: {
											...
											children: [[{
												key: "high",
												label: lang === "en" ? "Deep green ≥ (tokens)" : "深绿阈值 ≥（tokens）"
											}, {
												key: "low",
												label: lang === "en" ? "Light green < (tokens)" : "浅绿阈值 <（tokens）"
											...
											}, key)), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												style: {
													display: "flex",
													justifyContent: "space-between",
													alignItems: "center"
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
													...
													children: lang === "en" ? "Defaults" : "恢复默认"
												}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													style: {
														fontSize: 10,
														color: "var(--dsw-alias-label-tertiary)"
